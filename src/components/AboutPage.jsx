      ...
      <div id='about'>
        <FadeInSection>
          ...
          <div className='details'>
            <img src='./blob/main/assets/1x1.jpeg' className='pic'/>
          ...
          <div className='leadership'>
            <div className='orgs'>
              ...
              <div className='org-link'>
                ...
                <a href='https://www.facebook.com/catsofuplb' target="_blank" className='org-link-logo'><img src='./blob/main/assets/fb.png' className='org-link-logo'></img></a>
              </div>
            ...
            <div className='company'>
              ...
              <div className='company-link'>
                ...
                <a href='https://www.linkedin.com/company/supsoft-tech/' target="_blank" className='company-link-logo'>
                  <img src='./blob/main/assets/linkedin.png' className='company-link-logo'></img>
                </a>
              </div>                
